	...
	.constant('SCENES', {
		...
		elpis_scene_1: {
			...
			pages: [
				...
				{
					text: 'Già, la speranza, caro ragazzo. E’ proprio la speranza, radiosa e vitale tensione verso l’Oltre, che ha portato Ernst oltre di quel monte. Ernst è nato nel 1885, in Germania, a Ludwigshafen. Ha studiato a Monaco e a Würzburg.',
					//textClass: 'bubble-talete',
					//positionClass: 'bubble-dialog-left bubble-position-talete',
					positionClass: 'bubble-dialog-left',
					//nextLabel: 'Vai avanti',
...
// FOBOS
	    ...
	    fobos_scene_6: {
			...
			background: 'fobos_01_bg.jpg',
			firstQuestion: 'fobos_scene_6_survey_1',

			// 


		questions: {
				fobos_scene_6_survey_1: {
					id: 'fobos_scene_6_survey_1',
					text: 'Vivere rispettando le leggi rappresenta:',
					answers: [
						{
							text: 'una necessità per ciascun uomo, al pari della libertà',
							nextQuestion: 'fobos_scene_6_survey_2',
							textAfter: 'Corretto! Vai avanti...'
						},
						{
							text: 'uno stato di paura permanente',
							nextQuestion: 'fobos_scene_6_survey_1',
							textAfter: 'Sbagliato! Ripeti il questionario.' 
						}
					],
					answerLabel: 'Scegli',
				...
				fobos_scene_6_survey_2: {
					id: 'fobos_scene_6_survey_2',
					...
					answers: [
						...
						},
						{
							...
							nextQuestion: 'fobos_scene_6_survey_3',
							textAfter: 'Corretto! Vai avanti...'
						}
					],
					answerLabel: 'Scegli',
				...
				fobos_scene_6_survey_3: {
					id: 'fobos_scene_6_survey_3',
...
fobos_scene_5: {
			...
			nextScene: '',
			background: 'fobos_01_bg.jpg',
			firstDialog: 'fobos_scene_5_dialog_1',
			dialogs: {
				fobos_scene_5_dialog_1: {
					id: 'fobos_scene_5_dialog_1',
					...
					positionClass: 'bubble-dialog-left',
					//exitType: 'dialog', // dialog, choice, scene
					nextDialog: 'fobos_scene_5_dialog_2',
					//nextLabel: 'Vai avanti',
					//nextClass: 'button-bottom'
				},
				fobos_scene_5_dialog_2: {
					id: 'fobos_scene_5_dialog_2',
					text: 'Certo che lo è... cos\' è che non ti è chiaro?',
					//textClass: 'bubble-talete',
					positionClass: 'bubble-dialog-top',
					//exitType: 'dialog', // dialog, choice, scene
					nextDialog: 'fobos_scene_5_dialog_3',
					//nextLabel: 'Vai avanti',
					//nextClass: 'button-bottom'
				},
				fobos_scene_5_dialog_3: {
					id: 'fobos_scene_5_dialog_3',
					...
					choices: [
						{
							...
							nextDialog: 'fobos_scene_5_dialog_4'
						},
						{
							text: 'Non capisco perchè la paura è alla base di ogni società',
							nextDialog: 'fobos_scene_5_dialog_15'
						}
					],
					choiceLabel: 'Scegli',
					choiceClass: 'button-dialog'
				},
				fobos_scene_5_dialog_4: {
					id: 'fobos_scene_5_dialog_4',
					...
					positionClass: 'bubble-dialog-top',
					//exitType: 'dialog', // dialog, choice, scene
					nextDialog: 'fobos_scene_5_dialog_5',
					//nextLabel: 'Vai avanti',
					//nextClass: 'button-bottom'
				},
				fobos_scene_5_dialog_5: {
					id: 'fobos_scene_5_dialog_5',
					text: 'Guidato solo dal tuo istinto',
					//textClass: 'bubble-talete',
					positionClass: 'bubble-dialog-left',
					//exitType: 'dialog', // dialog, choice, scene
					nextDialog: 'fobos_scene_5_dialog_6',
					//nextLabel: 'Vai avanti',
					//nextClass: 'button-bottom'
				},
				fobos_scene_5_dialog_6: {
					id: 'fobos_scene_5_dialog_6',
					...
					positionClass: 'bubble-dialog-top',
					//exitType: 'dialog', // dialog, choice, scene
					nextDialog: 'fobos_scene_5_dialog_7',
					//nextLabel: 'Vai avanti',
					//nextClass: 'button-bottom'
				},
				fobos_scene_5_dialog_7: {
					id: 'fobos_scene_5_dialog_7',
					text: '...beh, vincerebbe l\'istinto più forte!',
					//textClass: 'bubble-talete',
					positionClass: 'bubble-dialog-right',
					//exitType: 'dialog', // dialog, choice, scene
					nextDialog: 'fobos_scene_5_dialog_8',
					//nextLabel: 'Vai avanti',
					//nextClass: 'button-bottom'
				},
				fobos_scene_5_dialog_8: {
					id: 'fobos_scene_5_dialog_8',
					text: 'E questo non ti fa ancora più paura?',
					//textClass: 'bubble-talete',
					positionClass: 'bubble-dialog-top',
					//exitType: 'dialog', // dialog, choice, scene
					nextDialog: 'fobos_scene_5_dialog_9',
					//nextLabel: 'Vai avanti',
					//nextClass: 'button-bottom'
				},
				fobos_scene_5_dialog_9: {
					id: 'fobos_scene_5_dialog_9',
					text: 'Quindi la paura è un limitatore di velocità...',
					//textClass: 'bubble-talete',
					positionClass: 'bubble-dialog-right',
					//exitType: 'dialog', // dialog, choice, scene
					nextDialog: 'fobos_scene_5_dialog_10',
					//nextLabel: 'Vai avanti',
					//nextClass: 'button-bottom'
				},
				fobos_scene_5_dialog_10: {
					id: 'fobos_scene_5_dialog_10',
					...
					positionClass: 'bubble-dialog-top',
					//exitType: 'dialog', // dialog, choice, scene
					nextDialog: 'fobos_scene_5_dialog_11',
					//nextLabel: 'Vai avanti',
					//nextClass: 'button-bottom'
				},
					fobos_scene_5_dialog_11: {
					id: 'fobos_scene_5_dialog_11',
					text: 'La felicità?',
					//textClass: 'bubble-talete',
					positionClass: 'bubble-dialog-right',
					//exitType: 'dialog', // dialog, choice, scene
					nextDialog: 'fobos_scene_5_dialog_12',
					//nextLabel: 'Vai avanti',
					//nextClass: 'button-bottom'
				},
					fobos_scene_5_dialog_12: {
					id: 'fobos_scene_5_dialog_12',
					...
					positionClass: 'bubble-dialog-top',
					//exitType: 'dialog', // dialog, choice, scene
					nextDialog: 'fobos_scene_5_dialog_13',
					//nextLabel: 'Vai avanti',
					//nextClass: 'button-bottom'
				},
					fobos_scene_5_dialog_13: {
					id: 'fobos_scene_5_dialog_13',
					text: 'Chiaro',
					//textClass: 'bubble-talete',
					positionClass: 'bubble-dialog-right',
					//exitType: 'dialog', // dialog, choice, scene
					nextDialog: 'fobos_scene_5_dialog_14',
					//nextLabel: 'Vai avanti',
					//nextClass: 'button-bottom'
				},
					fobos_scene_5_dialog_14: {
					id: 'fobos_scene_5_dialog_14',
					text: 'Ora, senza paura, percorri le altre strade di Sophia e torna qua per nuovi punti di vista su questa emozione!',
					//textClass: 'bubble-talete',
					positionClass: 'bubble-dialog-top',
					//exitType: 'dialog', // dialog, choice, scene
					nextDialog: 'fobos_scene_5_dialog_14bis',
					//nextLabel: 'Vai avanti',
					//nextClass: 'button-bottom'
				},
				fobos_scene_5_dialog_14bis: {
					id: 'fobos_scene_5_dialog_14bis',
					text: '',
					video: 'https://www.youtube.com/embed/7JQHDr72ZuM',
					textClass: '',
					positionClass: '',
					nextDialog: 'fobos_scene_5_dialog_14ter',
				},
				fobos_scene_5_dialog_14ter: {
					text: 'Torna alla mappa...',
					positionClass: 'bubble-dialog-left',
					exitType: 'scene', // dialog, choice, scene
					nextScene: '',
				...
				fobos_scene_5_dialog_15: {
					id: 'fobos_scene_5_dialog_15',
					...
					positionClass: 'bubble-dialog-top',
					//exitType: 'dialog', // dialog, choice, scene
					nextDialog: 'fobos_scene_5_dialog_16',
					//nextLabel: 'Vai avanti',
					//nextClass: 'button-bottom'
				},
				fobos_scene_5_dialog_16: {
					id: 'fobos_scene_5_dialog_16',
					text: 'E fin qui ci sono...',
					//textClass: 'bubble-talete',
					positionClass: 'bubble-dialog-right',
					//exitType: 'dialog', // dialog, choice, scene
					nextDialog: 'fobos_scene_5_dialog_17',
					//nextLabel: 'Vai avanti',
					//nextClass: 'button-bottom'
				},
				fobos_scene_5_dialog_17: {
					id: 'fobos_scene_5_dialog_17',
					...
					positionClass: 'bubble-dialog-top',
					//exitType: 'dialog', // dialog, choice, scene
					nextDialog: 'fobos_scene_5_dialog_18',
					//nextLabel: 'Vai avanti',
					//nextClass: 'button-bottom'
				},
				fobos_scene_5_dialog_18: {
					id: 'fobos_scene_5_dialog_18',
					text: 'Ma la paura che c\'entra?',
					//textClass: 'bubble-talete',
					positionClass: 'bubble-dialog-right',
					//exitType: 'dialog', // dialog, choice, scene
					nextDialog: 'fobos_scene_5_dialog_19',
					//nextLabel: 'Vai avanti',
					//nextClass: 'button-bottom'
				},
				fobos_scene_5_dialog_19: {
					id: 'fobos_scene_5_dialog_19',
					...
					positionClass: 'bubble-dialog-top',
					//exitType: 'dialog', // dialog, choice, scene
					nextDialog: 'fobos_scene_5_dialog_20',
					//nextLabel: 'Vai avanti',
					//nextClass: 'button-bottom'
				},
				fobos_scene_5_dialog_20: {
					id: 'fobos_scene_5_dialog_20',
					text: 'Come un patto, come un contratto stretto con una scorta',
					//textClass: 'bubble-talete',
					positionClass: 'bubble-dialog-right',
					//exitType: 'dialog', // dialog, choice, scene
					nextDialog: 'fobos_scene_5_dialog_21',
					//nextLabel: 'Vai avanti',
					//nextClass: 'button-bottom'
				},
				fobos_scene_5_dialog_21: {
					id: 'fobos_scene_5_dialog_21',
					text: 'Esatto... ma visto che riguarda tutti, non è un contratto individuale ma un contratto sociale',
					//textClass: 'bubble-talete',
					positionClass: 'bubble-dialog-top',
					//exitType: 'dialog', // dialog, choice, scene
					nextDialog: 'fobos_scene_5_dialog_22',
					//nextLabel: 'Vai avanti',
					//nextClass: 'button-bottom'
				},
				fobos_scene_5_dialog_22: {
					id: 'fobos_scene_5_dialog_22',
					text: 'Conosci Rousseau?',
					//textClass: 'bubble-talete',
					positionClass: 'bubble-dialog-left',
					//exitType: 'dialog', // dialog, choice, scene
					nextDialog: 'fobos_scene_5_dialog_23',
					//nextLabel: 'Vai avanti',
					//nextClass: 'button-bottom'
				},
				fobos_scene_5_dialog_23: {
					id: 'fobos_scene_5_dialog_23',
					text: 'No, non l\'ho ancora studiato',
					//textClass: 'bubble-talete',
					positionClass: 'bubble-dialog-right',
					//exitType: 'dialog', // dialog, choice, scene
					nextDialog: 'fobos_scene_5_dialog_24',
					//nextLabel: 'Vai avanti',
					//nextClass: 'button-bottom'
				},
				fobos_scene_5_dialog_24: {
					id: 'fobos_scene_5_dialog_24',
					text: 'Beh, quando lo studierai ti verrà certamente in mente questa conversazione',
					//textClass: 'bubble-talete',
					positionClass: 'bubble-dialog-left',
					//exitType: 'dialog', // dialog, choice, scene
					nextDialog: 'fobos_scene_5_dialog_25',
					//nextLabel: 'Vai avanti',
					//nextClass: 'button-bottom'
				},
				fobos_scene_5_dialog_25: {
					id: 'fobos_scene_5_dialog_25',
					text: 'Chiaro',
					//textClass: 'bubble-talete',
					positionClass: 'bubble-dialog-right',
					//exitType: 'dialog', // dialog, choice, scene
					nextDialog: 'fobos_scene_5_dialog_26',
					//nextLabel: 'Vai avanti',
					//nextClass: 'button-bottom'
				},
				fobos_scene_5_dialog_26: {
					id: 'fobos_scene_5_dialog_26',
					text: 'Ora, senza paura, percorri le altre strade di Sophia e torna qua per nuovi punti di vista su questa emozione!',
					//textClass: 'bubble-talete',
					positionClass: 'bubble-dialog-top',
					//exitType: 'dialog', // dialog, choice, scene
					nextDialog: 'fobos_scene_5_dialog_26bis',
					//nextLabel: 'Vai avanti',
					//nextClass: 'button-bottom'
				},
				fobos_scene_5_dialog_26bis: {
					id: 'fobos_scene_5_dialog_26bis',
					text: '',
					video: 'https://www.youtube.com/embed/7JQHDr72ZuM',
					textClass: '',
					positionClass: '',
					nextDialog: 'fobos_scene_5_dialog_26ter',
				},
				fobos_scene_5_dialog_26ter: {
					text: 'Torna alla mappa...',
					positionClass: 'bubble-dialog-left',
					exitType: 'scene', // dialog, choice, scene
					nextScene: '',
		...
		lype_scene_1: {
			...
			dialogs: {
				...
				lype_scene_1_dialog_7: {
					...
					text: 'Anzitutto presentiamoci. Questo è l’arcipelago Lype, sul quale sorge il mio isolotto. In Italia mi chiamate Cartesio ma il mio vero cognome è Descartes. Sono nato a La Haye nel 1596 da una agiata famiglia della borghesia francese, che mi ha assicurato un’ottima educazione. Nel 1612 mi sono iscritto a Legge all’università e terminati gli studi ho intrapreso una serie di viaggi: già da ragazzo il mio pallino era elaborare un metodo scientifico universale, che fosse valido per ogni disciplina',
					//textClass: 'bubble-talete',
					positionClass: 'bubble-dialog-top',
		...
		lype_scene_6: {
			...
			dialogs: {
				...
				lype_scene_6_dialog_7: {
					...
					text: 'E cosa suggerì a Elisabetta?',
					//textClass: 'bubble-talete',
					positionClass: 'bubble-dialog-right',
		...
		aidos_scene_2: {
			...
			dialogs: {
				...
				aidos_scene_2_dialog_7: {
					...
					text: 'Scegli la risposta da dare ad Aristotele!',
					textClass: 'suggest',
					positionClass: 'suggest-top',
					exitType: 'choice', // dialog, choice, scene
					choices: [
				...
				aidos_scene_2_dialog_10: {
					text: 'Guardiamo questo approfondimento...',
